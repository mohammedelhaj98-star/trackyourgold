        ...
        <div className="grid gap-8 md:grid-cols-5">
          <div className="md:col-span-2">
            ...
            <p className="mt-3 max-w-xl text-sm leading-7 text-white/65">
              The product-facing site now starts at the homepage. Older market routes stay published in the background while we rebuild them one by one into a cleaner product experience.
            </p>
          </div>
          <div>
            <p className="text-xs uppercase tracking-[0.24em] text-white/45">Homepage</p>
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.24em] text-white/45">Background SEO</p>
            <div className="mt-4 flex flex-col gap-3 text-sm text-white/55">
              {siteConfig.seoNav.map((item) => (
